...
\pdfinfo{
/Title (INSERT TITLE HERE!  AND CHECK AUTHORS ARE CORRECT BELOW!)
/Author (Nathaniel Budijono, Phoebe Goldman, Jack Maloney, Joseph A. Mueller, Phillip Walker, Jack Ladwig, Richard G. Freedman)
...
\title{INSERT TITLE HERE!}%{My Publication Title --- Multiple Authors}
\author {
    % Authors
    Nathaniel Budijono\equalcontrib,\textsuperscript{\rm 1}
    Phoebe Goldman\equalcontrib, \textsuperscript{\rm 2}
    Jack Maloney\equalcontrib, \textsuperscript{\rm 1} \\
    Joseph A. Mueller, \textsuperscript{\rm 3,4}
    Phillip Walker, \textsuperscript{\rm 4}
    Jack Ladwig, \textsuperscript{\rm 4}
    Richard G. Freedman \textsuperscript{\rm 4}
}
\affiliations {
    % Affiliations
    \textsuperscript{\rm 1} University of Minnesota Twin Cities\\
    \textsuperscript{\rm 2} New York University\\
    \textsuperscript{\rm 3} University of Minnesota\\
    \textsuperscript{\rm 4} SIFT\\
