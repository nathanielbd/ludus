...
if __name__ == "__main__":
    ...
    makeplot(bruiser, f"{sys.argv[1]}/bruiser.pdf", title="Bruiser", xaxis="Health", yaxis="Attack")
    ...
    makeplot(rampage, f"{sys.argv[1]}/rampage.pdf", title="Rampage", xaxis="Age")
    ...
    makeplot(grow_on_damage, f"{sys.argv[1]}/grow_on_damage.pdf", title="Grow on Damage", xaxis="Health", yaxis="Attack")
    ...
    makeplot(explode_on_death, f"{sys.argv[1]}/explode_on_death.pdf", title="Explode on Death", xaxis="Health", yaxis="Attack")
    ...
    makeplot(bruiser_vs_grow, f"{sys.argv[1]}/bruiser_vs_grow.pdf", title="Bruiser Attack vs Grow on Damage Health", xaxis="Health", yaxis="Attack")
    ...
    makeplot(bear_vs_grow, f"{sys.argv[1]}/bear_vs_grow.pdf", title="Bear Attack vs Grow on Damage Health", xaxis="Health", yaxis="Attack")
    ...
    makeplot(bruiser_vs_explode, f"{sys.argv[1]}/bruiser_vs_explode.pdf", title="Bruiser Attack vs Explode on Death Health", xaxis="Health", yaxis="Attack")
