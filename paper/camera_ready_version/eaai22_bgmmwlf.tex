...
player improves their lineup by selecting cards from a shared pool. In
...
lineups that the game's designers expect to be played the most\footnote{Their specific auto battler %application
...
lineups.  As there are still too many lineups to consider for feasible automated
...
\begin{figure}[t]
	...
	\caption{Distribution of lineup winrates before optimization. }
	\label{fig:special_only_dist_before}

	\includegraphics[scale=0.5]{special_only_1_3_4_3_3_1_7_8_5_7}
	\caption{Distribution of lineup winrates after optimization. }
...
game matrices with each lineup as a strategy, and more.  The size of these data structures
